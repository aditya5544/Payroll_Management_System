...
<div class="btn align-items-center">
	...
	<spring:message code="delete.header" />
	</h1>
					...
					<div class="card bg-dark text-white" style="border-radius: 1rem;">
						<div class="card-body p-4 text-center">
							...
							<div class="mb-md-5 mt-md-4 pb-4">
								...
								<div class="form-outline form-white mb-4">
									<div style="display: flex; flex-direction: row;">
										...
										<spring:message code="lable.name" />
											...
											id="deleteEmpId" class="form-select"
                                ...
                                <div class="form-outline form-white mb-4">
                                    <div style="display: flex; flex-direction: row;">
                                        <label class="form-label" for="typeMonth" style="margin-right: 50px; width: 50%;">  <spring:message code="lable.month" />  </label>  
                                    <select style="height: 48px; margin-right: 4px; width: 288%;" id="deleteMonthId"
								...
								<div class="form-outline form-white mb-4">
									<div style="display: flex; flex-direction: row;">
										<label class="form-label" for="typeMonth"
											...
											<select
											style="height: 48px; margin-right: 4px; width: 288%;"
											id="deleteYearId" class="form-select"
											aria-label="Default select example">
                                ...
                                <div id="exceptionMessage" class="col-sm-12" style="display: none;">
									<div class="alert alert-danger">
										<span id="error"></span>
									</div>
								</div>
								<button class="btn btn-outline-light btn-lg px-2" type="submit"
									id="delete"><spring:message code="button.submit" /></button>
							</div>
						</div>
					</div>
				</div>
