...
<div class="btn align-items-center">
	...
	<h1 style="text-align: center;">Insert details to Search</h1>
						...
						<div class="card-body p-4 text-center">
							...
							<div class="mb-md-5 mt-md-4 pb-4">
								...
								<div class="form-outline form-white mb-4">
									<div style="display: flex; flex-direction: row;">
										<label class="form-label" for="typeMonth"
											...
											id="searchEmpId" class="form-select"
								...
								<div class="form-outline form-white mb-4">
									<div style="display: flex; flex-direction: row;">
										<label class="form-label" for="typeMonth"
											...
											style="height: 48px; margin-right: 4px; width: 288%;"
											id="searchMonth" class="form-select"
											aria-label="Default select example">
								...
								<div class="form-outline form-white mb-4">
									<div style="display: flex; flex-direction: row;">
										<label class="form-label" for="typeMonth"
											...
											<select
											style="height: 48px; margin-right: 4px; width: 288%;"
											id="searchYear" class="form-select"
											aria-label="Default select example">
								...
								<button class="btn btn-outline-light btn-lg px-2" type="submit"
									id="searchSubmit" class="btn btn-primary">Submit</button>
							</div>
						</div>
					</div>
				</div>
